document.addEventListener("DOMContentLoaded", () => {
    ...
    socket.on("user_joined", (data) => {
        addMessage(`User ${data.username} has joined the chat`, "system");
    });

    socket.on("user_left", (data) => {
        addMessage(`User ${data.username} has left the chat`, "system");
    });
    ...
    socket.on("username_updated", (data) => {
        addMessage(`Username ${data.old_username} changed to ${data.new_username}`, "system");

        if (currentUsername === data.old_username) {
